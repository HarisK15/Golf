...
class RegisterClientFormTestCase(TestCase):
    """
    Contains the test cases for the client registration form
    """
    ...
    def test_valid_client_registration_form(self):
        form = RegisterClientForm(data=self.form_input)
